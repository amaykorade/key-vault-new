        ...
        <div className="mb-4">
          <div className="flex items-center space-x-3 mb-3">
            <div className="flex-1 min-w-0">
              <h3 className="text-xl font-bold text-white truncate group-hover:text-blue-400 transition-colors duration-200">
                {formatName(secret.name)}
              </h3>
            </div>
            <div className="flex items-center space-x-2 flex-shrink-0">
              <span className={`px-3 py-1 rounded-full text-sm font-semibold border ${ENVIRONMENT_COLORS[secret.environment || 'unknown'] || 'bg-gray-500/20 text-gray-400 border-gray-500/30'}`}>

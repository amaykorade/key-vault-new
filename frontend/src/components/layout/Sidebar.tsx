...
export function Sidebar() {
  ...
  const projectsLinkTarget = currentOrganization?.id
      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="px-4 pb-3">
          <a
            ...
            className="group flex items-center gap-2 rounded-lg px-3 py-2 text-[11px] text-gray-400 hover:text-emerald-200 hover:bg-gray-800/80 transition-colors border border-transparent hover:border-emerald-500/30"
          >
            <svg className="w-3.5 h-3.5 text-gray-500 group-hover:text-emerald-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            <span className="truncate">
              Support: <span className="text-emerald-300">contact@apivault.it.com</span>
            </span>
          </a>
        </div>

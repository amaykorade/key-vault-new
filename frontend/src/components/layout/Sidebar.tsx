        ...
        <nav className="p-4 space-y-1">
          ...
          <div>
            <button
              ...
              className={`w-full flex items-center py-2 text-sm transition-colors duration-200 ${
                apiOpen ? 'text-gray-200' : 'text-gray-400 hover:text-gray-200'
              }`}
            >
              <svg className="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span className="truncate flex-1 text-left">API</span>
              <svg className={`w-3 h-3 transition-transform ${apiOpen ? 'rotate-90' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
